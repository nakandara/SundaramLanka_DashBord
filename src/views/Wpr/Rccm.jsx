...
export default function DenseTable() {
  ...
  const {kpi,dispatch,dateOne,dateTwo,rccmData,setRccmData} =useContext(reportContext)
...
var category =kpi.firstKpi
  ...
  const fetchDataRccm = async () => {
    try {
      const response = await api.get(`/reporting/rccm/${kpi.divrccm}/${category}/${paramDateOne}/${paramDateTwo}`);
    ...
    useEffect(()=>{
      fetchDataRccm()
  },[kpi.divrccm,paramDateOne,paramDateTwo])
...
<div className=' bo'
  ...
  <thead className="thead-dark">
    <tr>
      ...
      <th scope="col-md-1 col-sm-1 col-lg-1" >Metrix</th>
      ...
      <th scope="col-md-1 col-sm-1 col-lg-1" >Comp Date</th>
