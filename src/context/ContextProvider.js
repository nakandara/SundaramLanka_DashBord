...
const initialState = {
  firstKpi: "actual_weight",
  secondKpi: "plan_weight",
  condition: "sum",
  division: "production_data",
  divrccm: "production_rccm",
  titleOne: "Actual Weight(Ton)",
  titleTwo: "Plan Weight(Ton)",
};
...
const reducer = (state, action) => {
  switch (action.type) {
    case "plant_utilization":
      return {
        firstKpi: "plant_utilization",
        secondKpi: "plant_utilization_plan",
        condition: "avg",
        division: "production_data",
        divrccm: "production_rccm",
        titleOne: "Plant Utilization(%)",
        titleTwo: "Plan (%)",
      };
    case "plan_adherence":
      return {
        firstKpi: "plan_adherence",
        secondKpi: "plan_adherence_plan",
        condition: "avg",
        division: "production_data",
        divrccm: "production_rccm",
        titleOne: "Plan Adhernce(%)",
        titleTwo: "Plan(%)",
      };
    case "plan_vs_actual":
      return {
    ...
    case "productivity":
      return {
        firstKpi: "productivity",
        secondKpi: "productivity_plan",
        condition: "avg",
        division: "production_data",
        divrccm: "production_rccm",
        titleOne: "Production Productivity(Kg/mhr)",
        titleTwo: "Plan (Kg/mhr)",
      };
    case "ftr":
      return {
        firstKpi: "ftr",
        secondKpi: "ftr_plan",
        condition: "avg",
        division: "quality_data",
        divrccm: "quality_rccm",
        titleOne: "FTR (%)",
        titleTwo: "Plan (%)",
      };
    case "flash":
    ...
    case "holdCompound":
      return {
        firstKpi: "hold_compound",
        secondKpi: "hold_compound_plan",
        condition: "sum",
        division: "hold_data",
        divrccm: "hold_rccm",
        titleOne: "Hold Compound (Kg)",
        titleTwo: "Plan (Kg)",
      };
    case "rejectCompound":
      return {
        firstKpi: "reject_compound",
        secondKpi: "reject_compound_plan",
        condition: "sum",
        division: "hold_data",
        divrccm: "hold_rccm",
        titleOne: "Reject Compound (Kg)",
        titleTwo: "Plan (Kg)",
      };
    case "nmDirty":
      return {
        firstKpi: "nm_dirty_tires",
        secondKpi: "nm_dirty_tires_plan",
        condition: "sum",
        division: "quality_data",
        divrccm: "quality_rccm",
        titleOne: "NM Dirty Tires (Not)",
        titleTwo: "Plan (Not)",
      };
    case "compoundWeight":
      return {
        firstKpi: "compound_weight_actual",
        secondKpi: "compound_weight_plan",
        condition: "sum",
        division: "mixing_data",
        divrccm: "mixing_rccm",
        titleOne: "Compound Weight Actual (Kg)",
        titleTwo: "Plan (Kg)",
      };
    case "mixingBreakDown":
      return {
        firstKpi: "mixing_break_down",
        secondKpi: "mixing_break_down_plan",
        condition: "sum",
        division: "mixing_data",
        divrccm: "mixing_rccm",
        titleOne: "Mixing Break Down (hrs)",
        titleTwo: "Plan (hrs)",
      };
    case "mixingProductivity":
      return {
        firstKpi: "mixing_productivity",
        secondKpi: "mixing_productivity_plan",
        condition: "sum",
        division: "mixing_data",
        divrccm: "mixing_rccm",
        titleOne: "Mixing Productivity (Kg/hrs)",
        titleTwo: "Plan (Kg/hrs)",
      };
    case "mixingManPower":
      return {
        firstKpi: "mixing_man_power",
        secondKpi: "mixing_man_power_plan",
        condition: "sum",
        division: "mixing_data",
        divrccm: "mixing_rccm",
        titleOne: "Mixing Man Power (No)",
        titleTwo: "Plan (No)",
      };
    case "mixingEnergy":
      return {
        firstKpi: "mixing_energy",
        secondKpi: "mixing_energy_plan",
        condition: "avg",
        division: "mixing_data",
        divrccm: "mixing_rccm",
        titleOne: "Mixing Energy (Kwh)",
        titleTwo: "Plan (Kwh)",
      };
    case "energyCost":
      return {
        firstKpi: "energy_cost_kg",
        secondKpi: "energy_cost_kg_plan",
        condition: "avg",
        division: "eng_data",
        divrccm: "eng_rccm",
        titleOne: "Energy Cost Rate (Cost/Kg)",
        titleTwo: "Plan (Cost/Kg)",
      };
    case "energyConsumed":
      return {
        firstKpi: "energy_consumed",
        secondKpi: "energy_consumed_plan",
        condition: "avg",
        division: "eng_data",
        divrccm: "eng_rccm",
        titleOne: "Energy Consumed(Kwh)",
        titleTwo: "Plan (Kwh)",
      };
    case "breakdown":
      return {
        firstKpi: "break_down",
        secondKpi: "break_down_plan",
        condition: "avg",
        division: "eng_data",
        divrccm: "eng_rccm",
        titleOne: "Break Down (hrs)",
        titleTwo: "Plan (hrs)",
      };
    case "fireWoodCostRate":
      return {
        firstKpi: "firewood_cost_rate",
        secondKpi: "firewood_cost_rate_plan",
        condition: "avg",
        division: "eng_data",
        divrccm: "eng_rccm",
        titleOne: "Firewood Cost Rate (Cost/Kg)",
        titleTwo: "Plan (Cost/Kg)",
      };
    case "oil":
      return {
    ...
    case "pm":
      return {
        ...
        division: "eng_data",
        divrccm: "eng_rccm",
        titleOne: "PM Achivment (%)",
        titleTwo: "Plan (%)",
      };

    case "absentInform":
      return {
        firstKpi: "absent_inform",
        secondKpi: "absent_inform_plan",
        condition: "sum",
        division: "hr_data",
        divrccm: "hr_rccm",
        titleOne: "Absent Inform (No)",
        titleTwo: "Plan (No)",
      };
    case "absentNonInform":
      return {
        firstKpi: "absent_non_inform",
        secondKpi: "absent_non_inform_plan",
        condition: "sum",
        division: "hr_data",
        divrccm: "hr_rccm",
        titleOne: "Absent Non Inform (No)",
        titleTwo: "Plan (No)",
      };
    case "late":
      return {
    ...
    case "manPower":
      return {
        firstKpi: "man_power",
        secondKpi: "man_power_plan",
        condition: "sum",
        division: "hr_data",
        divrccm: "hr_rccm",
        titleOne: "Man Power (No)",
        titleTwo: "Plan (No)",
      };
    ...
    case "reportableAccident":
      return {
        firstKpi: "reportable_accident",
        secondKpi: "reportable_accident_plan",
        condition: "sum",
        division: "hr_data",
        divrccm: "hr_rccm",
        titleOne: "Reportable Accident (No)",
        titleTwo: "Plan (No)",
      };
    case "nearMiss":
      return {
        firstKpi: "near_miss",
        secondKpi: "near_miss_plan",
        condition: "sum",
        division: "hr_data",
        divrccm: "hr_rccm",
        titleOne: "Near Miss (No)",
        titleTwo: "Plan (No)",
      };
    case "kaizen":
      return {
        firstKpi: "kaizen",
        secondKpi: "kaizen_plan",
        condition: "sum",
        division: "hr_data",
        divrccm: "hr_rccm",
        titleOne: "Kaizen (No)",
    ...
    case "training":
      return {
        firstKpi: "training",
        secondKpi: "training_plan",
        condition: "sum",
        division: "hr_data",
        divrccm: "hr_rccm",
        titleOne: "Training (hrs)",
        titleTwo: "Plan (hrs)",
      };
    case "creelBead":
      return {
        firstKpi: "creel_bead_actual",
        secondKpi: "creel_bead_plan",
        condition: "sum",
        division: "bead_data",
        divrccm: "bead_rccm",
        titleOne: "Bead Production (No)",
        titleTwo: "Plan (No)",
      };
    case "rejectBead":
      return {
        firstKpi: "reject_bead",
        secondKpi: "reject_Bead_plan",
        condition: "sum",
        division: "bead_data",
        divrccm: "bead_rccm",
        titleOne: "Reject Bead  (No)",
        titleTwo: "Plan (No)",
      };
    case "beadEnergy":
      return {
        firstKpi: "bead_energy",
        secondKpi: "bead_energy_plan",
        condition: "avg",
        division: "bead_data",
        divrccm: "bead_rccm",
        titleOne: "Bead Energy (Kwh)",
        titleTwo: "Plan (Kwh)",
      };

    case "beadBreakDown":
      return {
        firstKpi: "bead_breakdown",
        secondKpi: "bead_breakdown_plan",
        condition: "sum",
        division: "bead_data",
        divrccm: "bead_rccm",
        titleOne: "Bead Break Down (hrs)",
        titleTwo: "Plan (hrs)",
      };
    case "beadProductivity":
      return {
        firstKpi: "bead_productivity_actual",
        secondKpi: "bead_productivity_plan",
        condition: "avg",
        division: "bead_data",
        divrccm: "bead_rccm",
        titleOne: "Bead Productivity (No/hrs)",
        titleTwo: "Plan (No/hrs)",
      };
    case "beadManPower":
      return {
        firstKpi: "bead_manpower_actual",
        secondKpi: "bead_manpower_plan",
        condition: "sum",
        division: "bead_data",
        divrccm: "bead_rccm",
        titleOne: "Bead Man Power (No)",
        titleTwo: "Plan (No)",
      };
    case "nonReportableAccident":
      return {
        firstKpi: "non_reportable_accident",
        secondKpi: "non_reportable_accident_plan",
        condition: "sum",
        division: "hr_data",
        divrccm: "hr_rccm",
        titleOne: "Non Reportable Accident (No)",
        titleTwo: "Plan (No)",
      };
    case "Tire Inverd":
      return {
      ...
      case "shot_blasting vs actual m1":
      return {
        firstKpi: "m1_actual",
        secondKpi: "m1_plan",
        condition: "sum",
        division: "shot_blasting",
        divrccm: "shot_blasting_rccm",
        titleOne: "Training (hrs)",
        titleTwo: "Plan (hrs)",
      };
      case "shot_blasting vs actual m2":
      return {
        firstKpi: "m2_actual",
        secondKpi: "m2_plan",
        condition: "sum",
      ...
      case "tire_stock_accuracy":
      return {
        firstKpi: "actual_stock",
        secondKpi: "m2_plan",
        condition: "sum",
        division: "fgs_accuracy",
        divrccm: "fgs_accuracy_rccm",
        titleOne: "Training (hrs)",
        titleTwo: "Plan (hrs)",
      };
      case "daily_pdi":
...
export const ContextProvider = (props) => {
  ...
  const [ddate, setDdate] = useState(
    myDateMain.setDate(myDateMain.getDate() - 1)
  );
  //console.log(ddate);

  const myDateMeter = new Date();
  const [medate, setMeDdate] = useState(
    myDateMeter.setDate(myDateMeter.getDate() - 1)
  );
  ...
  ////mfg pramod
  const [mfgTireinvert, setMfgTireinvert] = useState([]);
  const [tireInverdactual, setTireInverdactual] = useState([]);
  const [tireStkAcuuracyTar, setTireStkAcuuracyTar] = useState([]);
  const [dailypdi, setDailypdi] = useState([]);
  const [shipment, setShipment] = useState([]);
  const [shipment2, setShipment2] = useState([]);
  const [fgsActual, setFgsActual] = useState([]);
  //const [shipmentplan, setShipmentplan] = useState([]);
  // pramod shotblasting
  const [shotblast1, setShotblast1] = useState([]);
  const [shotblast2, setShotblast2] = useState([]);
  ...
  const [weekDate, setWeekDate] = useState(
    myDateMain.setDate(myDateMain.getDate() - 7)
  );
  ...
  const [weekDateFour, setWeekDateFour] = useState(
    myDateMainTwo.setDate(myDateMainTwo.getDate() - 10)
  );

  const [weekDateThree, setWeekDateThree] = useState(
    myDateMainThree.setDate(myDateMainThree.getDate() - 17)
  );

  const [weekDateFive, setWeekDateFive] = useState(
    myDateMainFive.setDate(myDateMainFive.getDate() - 25)
  );

  const [weekDateSix, setWeekDateSix] = useState(
    myDateMainSix.setDate(myDateMainSix.getDate() - 18)
  );

  const [weekDateSeven, setWeekDateSeven] = useState(
    myDateMainSeven.setDate(myDateMainSeven.getDate() - 33)
  );

  const [weekDateEight, setWeekDateEight] = useState(
    myDateMainEight.setDate(myDateMainEight.getDate() - 26)
  );
    ...
    <div>
      <reportContext.Provider
        value={{
          ...
          setMfgDataCount,
          mfgDataFirstCount,
          setMfgDataFirstCount,
          mfgDataSecondCount,
          setMfgDataSecondCount,
          mfgDataThirdCount,
          setMfgDataThirdCount,
          mfgDataFourthCount,
          setMfgDataFourthCount,
          mfgDataFiveCount,
          setMfgDataFiveCount,
          mfgDataSixCount,
          setMfgDataSixCount,
          mfgDataSevenCount,
          setMfgDataSevenCount,
          mfgDataEightCount,
          setMfgDataEightCount,
          mfgDataMTD,
          setMfgDataMTD,
          mfgDataCountMTD,
          setMfgDataCountMTD,
          ...
          setQualityCountA,
          QualitySumWeightA,
          setQualitySumWeightA,
          QualitySumWeightAPlus,
          setQualitySumWeightAPlus,
          QualityCountAPlus,
          setQualityCountAPlus,
          QualitySumWeightB,
          setQualitySumWeightB,
          QualityCountB,
          setQualityCountB,
          QualitySumWeightE,
          setQualitySumWeightE,
          QualityCountE,
          setQualityCountE,
          QualitySumWeightR,
          setQualitySumWeightR,
          QualityCountR,
          setQualityCountR,
          QualitySumWeightL,
          setQualitySumWeightL,
          QualityCountL,
          setQualityCountL,
          qualityDataAMTD,
          setQualityDataAMTD,
          qualityDataCountAMTD,
          setQualityDataCountAMTD,
          qualityDataBMTD,
          setQualityDataBMTD,
          qualityDataCountBMTD,
          setQualityDataCountBMTD,
          qualityDataEMTD,
          setQualityDataEMTD,
          qualityDataCountEMTD,
          setQualityDataCountEMTD,
          qualityDataRMTD,
          setQualityDataRMTD,
          qualityDataCountRMTD,
          setQualityDataCountRMTD,
          qualityDataLMTD,
          setQualityDataLMTD,
          qualityDataCountLMTD,
          setQualityDataCountLMTD,
          qualityDataAPlusMTD,
          setQualityDataAPlusMTD,
          qualityDataCountAPlusMTD,
          setQualityDataCountAPlusMTD,
          kpi,
          dispatch,
          lineChartData,
          setLineChartData,
          ...
          setWeekDateEight,
          weekChartDataThree,
          setWeekChartDataThree,
          weekChartDataFour,
          setWeekChartDataFour,
          medate,
          setMeDdate,
          shift,
          setShift,
